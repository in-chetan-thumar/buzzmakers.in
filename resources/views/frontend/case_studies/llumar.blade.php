...
@section('main')
    ...
    <section class="responsive-container section-post">
        ...
        <div class="backround-square">
            ...
            <div class="container">
                <div>
                    <img src="{{ asset('assets/frontend/images/profile/lumar/lumarbanner.webp') }}" class="w-100"
                        alt="">
                </div>
                <div class="row my-5">
                    <div class="col-lg-9">
                        <img src="{{ asset('assets/frontend/images/profile/lumar/lumarbanner1.webp') }}" class="w-100"
                            alt="">
                    </div>
                    <div class="col-lg-3">
                        <img src="{{ asset('assets/frontend/images/profile/lumar/lumarbannersub2.webp') }}" class="w-100"
                            alt="">
                        <img src="{{ asset('assets/frontend/images/profile/lumar/lumarbannersub3.webp') }}" class="w-100"
                            alt="">
                    </div>
                </div>
                <div>
                    <img src="{{ asset('assets/frontend/images/profile/lumar/lumarbanner2.webp') }}" class="w-100"
                        alt="">
                </div>
            </div>
            ...
            <div class="position-relative">
                ...
                <img src="{{ asset('assets/frontend/images/profile/lumar/standee2.webp') }}" class="standee-banner"
                    alt="">
                    ...
                    <div class="inner-post-container">
                        <div class="row">
                            <div class="col-lg-4 mb-5">
                                <div class="shadow-solid aspect-r-11">
                                    <img src="{{ asset('assets/frontend/images/profile/lumar/posts1.webp') }}"
                                        class="w-100" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 mb-5">
                                <div class="shadow-solid aspect-r-11">
                                    <img src="{{ asset('assets/frontend/images/profile/lumar/posts2.webp') }}"
                                        class="w-100" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 mb-5">
                                <div class="shadow-solid aspect-r-11">
                                    <img src="{{ asset('assets/frontend/images/profile/lumar/posts3.webp') }}"
                                        class="w-100" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 mb-5">
                                <div class="shadow-solid aspect-r-11">
                                    <img src="{{ asset('assets/frontend/images/profile/lumar/posts4.webp') }}"
                                        class="w-100" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 mb-5">
                                <div class="shadow-solid aspect-r-11">
                                    <img src="{{ asset('assets/frontend/images/profile/lumar/posts5.webp') }}"
                                        class="w-100" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 mb-5">
                                <div class="shadow-solid aspect-r-11">
                                    <img src="{{ asset('assets/frontend/images/profile/lumar/posts6.webp') }}"
                                        class="w-100" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/reel/CoUcI89h3Zb/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                <div style="padding:16px;"> <a
                                        href="https://www.instagram.com/reel/CoUcI89h3Zb/?utm_source=ig_embed&amp;utm_campaign=loading"
                                    ...
                                    <p
                                        ...
                                        <a href="https://www.instagram.com/reel/CoUcI89h3Zb/?utm_source=ig_embed&amp;utm_campaign=loading"
                                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                            target="_blank">A post shared by TURTLE WAX CAR CARE DELHI
                                            (@celestialrides)</a></p>
                                </div>
                            </blockquote>
                        ...
                        <div class="col-lg-4">
                            {{--                            <img src="{{ asset('assets/frontend/images/profile/lumar/video.webp')}}" class="w-100" alt=""> --}}
                            <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/reel/CfbDHJgKI95/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                <div style="padding:16px;"> <a
                                        href="https://www.instagram.com/reel/CfbDHJgKI95/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"
                                        target="_blank">
                                        <div style=" display: flex; flex-direction: row; align-items: center;">
                                            <div
                                    ...
                                    <p
                                        style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                        <a href="https://www.instagram.com/reel/CfbDHJgKI95/?utm_source=ig_embed&amp;utm_campaign=loading"
                                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                            target="_blank">A post shared by AutOz ViLLe Detailing Studio™
                                            (@autozville)</a></p>
                                </div>
                            </blockquote>
                            <script async src="//www.instagram.com/embed.js"></script>
                        ...
                        <div class="col-lg-4">
                            {{--                            <img src="{{ asset('assets/frontend/images/profile/lumar/video.webp')}}" class="w-100" alt=""> --}}
                            <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/reel/CdNAX--DdH4/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                <div style="padding:16px;"> <a
                                        href="https://www.instagram.com/reel/CdNAX--DdH4/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"
                                        target="_blank">
                                        <div style=" display: flex; flex-direction: row; align-items: center;">
                                            <div
                                    ...
                                    <p
                                        style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                        <a href="https://www.instagram.com/reel/CdNAX--DdH4/?utm_source=ig_embed&amp;utm_campaign=loading"
                                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                            target="_blank">A post shared by LLumar Films (@llumarindia)</a></p>
                                </div>
                            </blockquote>
                            <script async src="//www.instagram.com/embed.js"></script>
                        </div>
