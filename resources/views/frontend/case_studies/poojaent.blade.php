    ...
    <div class="container-back-top-section">
        ...
        <section class="responsive-container section-text">
            <div class="container text-center py-5">
                ...
                <p class="mb-0">We integrate the brand's ‘No.1’ flagship identity and entwine it with our creative social
                    media narratives</p>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-3 col-md-3">
                            <div class="aspect-r-11 large-hash">
                                <img src="{{ asset('assets/frontend/images/profile/poojaent/big-hash-tag.webp') }}"
                                    class="w-100" alt="">
                            </div>
                            ...
                            <div class="img-eyes-up">
                                <img src="{{ asset('assets/frontend/images/profile/poojaent/eyes-up.webp') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="aspect-r-11 screen-post-main">
                                <img src="{{ asset('assets/frontend/images/profile/poojaent/postfilmtop.webp') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3">
                            <div class="aspect-r-11 small-hash">
                                <img src="{{ asset('assets/frontend/images/profile/poojaent/small-hash-tag.webp') }}"
                                    class="w-100" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="aspect-r-11">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/postfilmsub1.webp') }}"
                                class="w-100" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="aspect-r-11">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/postfilmsub2.webp') }}"
                                class="w-100" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="aspect-r-11">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/postfilmsub3.webp') }}"
                                class="w-100" alt="">
                        </div>
                    </div>

                    <!--  -->
                    <div class="img-eyes-right-bottom mobile_view_eye">
                        <img src="{{ asset('assets/frontend/images/profile/poojaent/eyes-riht-bottom.webp') }}"
                            alt="">
                    </div>
                    <div class="heading-bar mobile_view">
                    ...
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="aspect-r-11 shadow-solid">
                            <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/reel/CXi0htKIYCI/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                <div style="padding:16px;"> <a
                                        href="https://www.instagram.com/reel/CXi0htKIYCI/?utm_source=ig_embed&amp;utm_campaign=loading"
                                    ...
                                    <p
                                        ...
                                        <a href="https://www.instagram.com/reel/CXi0htKIYCI/?utm_source=ig_embed&amp;utm_campaign=loading"
                                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                            target="_blank">A post shared by Pooja Entertainment (@pooja_ent)</a></p>
                                </div>
                            </blockquote>
                            <script async src="//www.instagram.com/embed.js"></script>
                        </div>
                        <div class="img-eyes-right-bottom mobile_hide_eye">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/eyes-riht-bottom.webp') }}"
                                alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="heading-bar mobile_hide">
                            <h3 class="fw-bold">We Manipulate.</h3>
                            <label>You Relate!</label>
                        </div>
                        <div class="aspect-r-11 shadow-solid">
                            <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/reel/CZ1GYYgPMZ0/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                <div style="padding:16px;"> <a
                                        href="https://www.instagram.com/reel/CZ1GYYgPMZ0/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"
                                        target="_blank">
                                        <div style=" display: flex; flex-direction: row; align-items: center;">
                                            <div
                    ...
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="aspect-r-11 shadow-solid">
                            <blockquote class="instagram-media"
                                data-instgrm-permalink="https://www.instagram.com/reel/CcHvemUtbSt/?utm_source=ig_embed&amp;utm_campaign=loading"
                                data-instgrm-version="14"
                                style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                                <div style="padding:16px;"> <a
                                        href="https://www.instagram.com/reel/CcHvemUtbSt/?utm_source=ig_embed&amp;utm_campaign=loading"
                                        style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"
                                        target="_blank">
                                        <div style=" display: flex; flex-direction: row; align-items: center;">
                                            <div
                                    ...
                                    <p
                                        style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                        <a href="https://www.instagram.com/reel/CcHvemUtbSt/?utm_source=ig_embed&amp;utm_campaign=loading"
                                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                            target="_blank">A post shared by Pooja Entertainment (@pooja_ent)</a></p>
                                </div>
                            </blockquote>
                        ...
                        <div class="img-eyes-left-bottom">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/eyes-left-bottom.webp') }}"
                                alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 mb-5">
                        <div class="aspect-r-11 shadow-solid mt-5">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/posts4.webp') }}" class="w-100"
                                alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="aspect-r-11 shadow-solid">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/posts5.webp') }}" class="w-100"
                                alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 ">
                        <div class="aspect-r-11 shadow-solid mt-5">
                            <img src="{{ asset('assets/frontend/images/profile/poojaent/posts6.webp') }}" class="w-100"
                                alt="">
                        </div>
                    </div>
                </div>
