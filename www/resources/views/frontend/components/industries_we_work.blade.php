        ...
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="pills-finance" role="tabpanel" aria-labelledby="pills-finance-tab">
            <div class="ind-tab-details">
              <div>
                <img src={{asset('assets/frontend/images/computer.webp')}} class="img-tabs" alt="computer">
                <img src={{asset('assets/frontend/images/line-bar.svg')}} class="img-tabs-pattern" alt="line-bar">
              </div>
