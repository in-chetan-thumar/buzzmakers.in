                                                                ...
                                                                <table  border="0" cellspacing="0" cellpadding="0" style="width:100%;border:solid 1px #dbdbdb;background:#fff">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="50%" align="right" style="font-family:Open Sans,Arial,sans-serif;font-size:13px; text-align: center;padding:10px; border-bottom: 1px dotted #868686;color: #555555;"> ' . $_POST['name'] . ' </td>
                                                                        </tr>
																		 ...
																		 <tr>
                                                                            ...
                                                                            <td align="right" style="font-family:Open Sans,Arial,sans-serif;font-size:13px; width: 50%;text-align: center;padding:10px;border-bottom: 1px dotted #868686;color: #555555;"> ' . $_POST['email'] . ' </td>
                                                                        </tr>
																		 <tr>
                                                                            ...
                                                                            <td align="right" style="font-family:Open Sans,Arial,sans-serif;font-size:13px; width: 50%;text-align: center;padding:10px;border-bottom: 1px dotted #868686;color: #555555;"> ' . $_POST['mobile'] . ' </td>
                                                                        </tr>
																			 <tr>
