...
class SalviController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOTools::opengraph()->addImage(url('assets/frontend/images/OurWork/salvi.jpg'));
        return view('frontend.case_studies.salvi_chemical', compact('content'));
    }
