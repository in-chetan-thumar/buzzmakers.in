...
class NutraCareController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOTools::opengraph()->addImage(url('assets/frontend/images/OurWork/nutra.jpg'));
        return view('frontend.case_studies.nutra_care', compact('content'));
    }
