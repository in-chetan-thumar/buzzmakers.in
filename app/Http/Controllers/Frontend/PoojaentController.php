...
class PoojaentController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOTools::opengraph()->addImage(url('assets/frontend/images/OurWork/pooja.jpg'));
        return view('frontend.case_studies.poojaent', compact('content'));
    }
