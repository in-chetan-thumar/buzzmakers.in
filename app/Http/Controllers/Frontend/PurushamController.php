...
class PurushamController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOTools::opengraph()->addImage(url('assets/frontend/images/OurWork/purusham.jpg'));
        return view('frontend.case_studies.purusham', compact('content'));
    }
